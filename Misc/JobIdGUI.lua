...
if CoreGui.RobloxPromptGui.promptOverlay:WaitForChild("ErrorPrompt") then
       if CoreGui.RobloxPromptGui.promptOverlay.ErrorPrompt.MessageArea.ErrorFrame.ButtonArea:FindFirstChild("OkButton") then
           ...
           GuiService:SetCore("SendNotification", {Title = "Job Id Joiner",Text = "Error, Invalid Job ID";})
       else
           GuiService:SetCore("SendNotification", {Title = "Job Id Joiner",Text = "Successful, Joining Server";})  
       end
end
end)
...
GuiService:SetCore("SendNotification", {Title = "Job Id Joiner",Text = "Copied Job ID to Your Clipboard";})
...
GuiService:SetCore("SendNotification", {Title = "Job Id Joiner",Text = "Closing Gui";})
JobIDGui:Destroy()
end)
